...
# 0. book rec test...book rec streamlit
# 1. Go to all_books...full df
# 2. Find a way to guess fiction vs. nonfiction
# 3. Include it in books_author_date

# all_books = pd.read_parquet("data/all_books.parquet")
all_books = pd.read_parquet("data/all_books_with_type.parquet")
